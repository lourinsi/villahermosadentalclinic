  ...
  return (
    <div className="space-y-8 p-4 md:p-8 max-w-7xl mx-auto">
      <div className="flex flex-col gap-4">
        <h1 className="text-3xl font-bold tracking-tight">Dental Specialists</h1>
        <p className="text-muted-foreground text-lg">
          Manage and view the team of experienced professionals in our clinic.
        </p>
      </div>
          ...
          filteredDoctors.map(doctor => (
            <Card key={doctor.id} className="overflow-hidden flex flex-col hover:shadow-md transition-shadow">
              ...
              <CardFooter className="pt-2 border-t bg-muted/5 flex flex-col gap-2">
                <Button 
                  onClick={() => router.push(`/admin/calendar?doctor=${encodeURIComponent(doctor.id)}`)}
...
export default FindDoctorsAdminPage;
